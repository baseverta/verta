...
**Objetivo do site:** Converter visitantes em **Agendamentos de Diagnóstico Operacional de 45 minutos**.  
**Público-alvo:** Donos e gestores de PMEs de serviço com decisor único, ticket a partir de R$ 200 e pelo menos 40 conversas/mês entrando pelo WhatsApp. Não há piso de faturamento — a entrada é definida pelo Índice de Recuperação (ver `COMERCIAL.md`, seção 3).  
...
3. WhatsApp  
4. E-mail  
5. Faturamento mensal (select): Até R$ 15 mil | R$ 15–100 mil | R$ 100–500 mil | Acima de R$ 500 mil  
...
**Integração:** formulário em dois passos (Tally ou Webflow) com liberação condicional. O Calendly é embutido apenas na tela de sucesso, e só aparece para quem passa nos critérios de ticket e volume. Ver `COMERCIAL.md`, seção 5, etapa 4.
